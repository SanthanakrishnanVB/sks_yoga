...
# === STRICTNESS SETTINGS ===
STRICT_TOLERANCE = 15.0  # Allowed error in degrees.
SEQ_LENGTH = 30
NUM_NODES = 33
CHANNELS = 3
BATCH_SIZE = 16
...
class YogaSystem:
    ...
    def is_valid_variation(self, pose_name, joint, user_angle, ideal_angle):
        pose = pose_name.lower()
        if "padamasana" in pose or "lotus" in pose:
            if "Knee" in joint and (user_angle < 60 or user_angle < ideal_angle): return True
            if "Hip" in joint and user_angle < 110: return True
            if "Elbow" in joint and user_angle > 120: return True
        return False
    ...
    def analyze_webcam(self):
        ...
        while cap.isOpened():
            ...
            # Flip image like a mirror (so raising right hand looks natural)
            ...
            # Draw the stick-figure (skeleton) on the user's body
            if landmarks:
            ...
            # Generate and Show the Live Dashboard
